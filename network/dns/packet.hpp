...
namespace Dometer::Network::Dns {
    class Packet {
        public:
            static Packet copyPacket(Packet& packet);
            static Packet formatError(Packet& query); 
            ...
            static Packet notImplemented(Packet& query); 
            static Packet serverFailure(Packet& query); 
